...
const CircuitService = {
    getCircuits: (params: any) => axios.get(`${API_URL}api/v1/regions/${params.region_id}/districts/${params.district_id}/circuits/?current_page=${params.current_page}&per_page=${params.perPage}`, { headers: authHeader() }),
