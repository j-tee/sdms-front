...
const AdmissionService = {
  ...
  getAdmissions: (params: AdmissionParams) =>
    axios.get(`${API_URL}api/v1/admissions/${params.department_id}/admissions?branch_id=${params.branch_id}&department_id=${params.department_id}&page=${params.pagination?.current_page}&per_page=${params.pagination?.per_page}&paginate=${params.paginate}`, { headers: authHeader() }),
