...
const CalendarService = {
  ...
  getAcademicTerms: (params: QueryParams) => axios.get(`${API_URL}api/v1/academic_years/${params.academic_year_id}/academic_terms?page=${params.pagination?.current_page}&per_page=${params.pagination?.per_page}`, { headers: authHeader() }),
