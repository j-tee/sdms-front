...
const DistrictService = {
  getDistricts: (params: any) => axios.get(`${API_URL}api/v1/regions/${params.region_id}/districts?current_page=${params.current_page}&per_page=${params.perPage}`, { headers: authHeader() }),
