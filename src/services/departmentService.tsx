...
const DepartmentService = {
  ...
  axios.get(`${API_URL}api/v1/departments?branch_id=${params.branch_id}&school_id=${params.school_id}&current_page=${params.pagination?.current_page}&per_page=${params.pagination?.per_page}&paginate=${params.paginate}`, { headers: authHeader() }),
