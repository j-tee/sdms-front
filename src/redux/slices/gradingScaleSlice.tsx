...
export const deleteGradingScale = createAsyncThunk(
    ...
    async (gradingScale: any, thunkAPI) => {
        try {
            const response = await GradingScaleService.deleteGradingScale(gradingScale);
            return response.data;
        } catch (error: any) {
            return thunkAPI.rejectWithValue(error.response.data);
        }
...
export const updateGradingScale = createAsyncThunk(
    ...
    async (gradingScale: any, thunkAPI) => {
        try {
            const response = await GradingScaleService.updateGradingScale(gradingScale);
            return response.data;
        } catch (error: any) {
            return thunkAPI.rejectWithValue(error.response.data);
        }
...
export const gradingScaleSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(addGradingScale.rejected, (state, action: PayloadAction<any>) => ({
            ...state,
            isLoading: false,
            status: "failed",
        ...
        builder.addCase(getGradingScales.rejected, (state, action: PayloadAction<any>) => ({
            ...state,
            isLoading: false,
            status: "failed",
            message: action.payload.message,
        ...
        builder.addCase(deleteGradingScale.fulfilled, (state, action) => ({
            ...state,
            gradingScales: state.gradingScales.filter(gradingScale => gradingScale.id !== action.payload.id),
            isLoading: false,
            status: "success",
            message: action.payload.message,
        }));

        builder.addCase(deleteGradingScale.rejected, (state, action: PayloadAction<any>) => ({
            ...state,
            isLoading: false,
            status: "failed",
            message: action.payload.message,
        ...
        builder.addCase(updateGradingScale.fulfilled, (state, action) => ({
            ...state,
            gradingScales: state.gradingScales.map(gradingScale => gradingScale.id === action.payload.id ? action.payload : gradingScale),
            isLoading: false,
            status: "success",
            message: action.payload.message,
        }));
        builder.addCase(updateGradingScale.rejected, (state, action: PayloadAction<any>) => ({
            ...state,
            isLoading: false,
            status: "failed",
            message: action.payload.message,
        ...
        builder.addCase(getGradingScale.rejected, (state, action: PayloadAction<any>) => ({
            ...state,
            isLoading: false,
            status: "failed",
            message: action.payload.message,
